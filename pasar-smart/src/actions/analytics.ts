...
export async function generateAIRecommendations(
  ...
  try {
    ...
    const prompt = `Anda adalah ahli bisnes pasar malam. Berdasarkan data berikut, berikan 3-5 rekomendasi spesifik dan dapat ditindaklanjuti untuk meningkatkan penjualan dan performa:
      ...
      contents: [
        {
          ...
          parts: [
            {
              text: `Anda adalah ahli bisnes pasar malam yang memberikan rekomendasi berbasis data dalam format JSON.\n\n${prompt}`,
            },
          ],
        },
      ],
